<script>
  ...
  // Edit these to taste — they render the mono "profile" block.
  const facts = [
    { label: "ROLE", value: "Independent security researcher" },
    { label: "FOCUS", value: "Memory safety · protocol parsers · fuzzing" },
    { label: "BASED", value: "Remote" },
    { label: "DISCLOSURE", value: "Coordinated · 90-day default" },
  ];
</script>
...
<main>
  <section class="intro">
    ...
    <h1>Hi, I'm Springfield Yonga<Cursor>.</Cursor></h1>
  </section>
  ...
  <div class="body">
    ...
    <p>
      ...
      around them: the dead ends, the tooling, and the parts that don't fit in a
      CVE description. If a write-up here saves you three weeks of heap
      grooming, it did its job.
    </p>

    <h2 class="section-head">02_PROFILE</h2>
    <dl class="facts">
    ...
    <p>
      ...
      over <a class="inline-link" href="/rss.xml">RSS</a>.
    </p>
  </div>
</main>
